                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Nguyên liệu mới</h3>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputName" class="form-control" value="{{ old('name') }}"
                                        name="name">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="inputName" class="form-control" value="{{ old('amount') }}"
                                        name="amount" min="1">
                                    @error('amount')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputStatus" class="form-control custom-select" name="category_ingre_id">
                                        ...
                                        @foreach ($categoryIngres as $categoryIngre)
                                            <option value="{{ $categoryIngre->id }}">{{ $categoryIngre->name }}</option>
                                        @endforeach
                                    </select>
