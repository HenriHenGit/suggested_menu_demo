                                    ...
                                    @foreach ($days as $index => $day)
                                        <li class="nav-item">
                                            <a class="nav-link {{ $day['isToday'] ? 'active' : '' }}"
                                                href="#{{ 'tab' . $index }}" data-toggle="tab">
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    @foreach ($meals as $i => $meal)
                                        @php
                                            $isActive = isset($days[$i]) && $days[$i]['isToday'];
                                        @endphp
                                        <div class="tab-pane {{ $isActive ? 'active' : '' }}" id="{{ 'tab' . $i }}">
                                            ...
                                            <div class="row">
                                                @foreach ($meal['meal'] as $number => $mealFood)
                                                    ...
                                                    @if ($number == 3)
                                                        <div class="col-md-12">
                                                            <div class="badge bg-success" style="font-size: 1.5rem;">
                                                    ...
                                                    @if ($number == 6)
                                                        <div class="col-md-12">
                                                            <div class="badge bg-info" style="font-size: 1.5rem;">
                                                                <i class="fas fa-moon"></i> Bữa ăn chiều
                                                            </div>
                                                        </div>
                                                    @endif
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h3 class="card-title">Thông tin bữa ăn và dinh dưỡng của bạn</h3>
                                                    </div>
                                                    <!-- /.card-header -->
